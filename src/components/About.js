...
const About = () => {
  ...
  return <about className='section' id='about' ref={ref}>
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
        ...
        <motion.div variants={fadeIn('left', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex-1'>
          ...
          <h3 className='h3 mb-4'>I'm a Full-Stack Developer with experience in Javascript, Python, and C# stacks.</h3>
          <p className='mb-6'>I have over 5 years of experience working in various public safety roles. My educational background is in animal sciences and software development.</p>
