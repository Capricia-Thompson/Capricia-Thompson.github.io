    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        <motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex-1 flex justify-start items-center'>
          <div>
            <h4 className='text-xl text-accent font-medium mb-2 tracking-wide'>I'd love to hear from you!</h4>
            <h2 className='text-[45px] lg:text-[90px] leading-none mb-12 uppercase'>Get in touch</h2>
          </div>
        </motion.div>
